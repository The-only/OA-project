		...
		<div class="top">
			...
			<div class="container">
				...
				<table class="table table-striped">
					...
					<c:forEach items="${vo.cardfloders}" var="cardfloder">
						<tr>
							...
							<td><a
								href="getCards_leader.action?vo.cid=${cardfloder.cid }&vo.cur=1">查看</a></td>
							<td><a
								href="deleteCardfloder_leader.action?vo.cid=${cardfloder.cid}"
				...
				<ul class="pagination">
					...
					<li><a href="getCardfloders_leader.action?vo.cur=1">首页</a></li>
					<c:if test="${vo.cur==1}">
						<li class="disabled"><a>上一页</a></li>
					</c:if>
					<c:if test="${vo.cur!=1}">
						<li><a href="getCardfloders_leader.action?vo.cur=${vo.cur-1}">上一页</a></li>
					</c:if>
					<c:if test="${vo.cur==vo.total}">
						<li class="disabled"><a>下一页</a></li>
					</c:if>
					<c:if test="${vo.cur!=vo.total}">
						<li><a href="getCardfloders_leader.action?vo.cur=${vo.cur+1}">下一页</a></li>
					</c:if>
					<li><a href="getCardfloders_leader.action?vo.cur=${vo.total}">尾页</a></li>



					<li><a>
							<form class="form-inline" name="fenyeStaff"
								action="getCardfloders_leader.action" method="post">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="addCardfloder_leader.action" method="post">
