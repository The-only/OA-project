	...
	<div style="width:100%">
		...
		<div style="float:right;width:85%;">
			<div class="top">
			  ...
			  <form class="form-inline well" role="form" action="sendCard_leader.action" method="post">
			  ...
			  <table  class="table table-striped" style="width: 960px;text-align: center;">
			     ...
			     <div align="center"> 
			        <button type="submit" class="btn btn-default"onclick="window.location.replace('getCards_leader.action?vo.cid=${vo.cid}');">返回</button>
			    </div>
			  </div>
			 </div>
			</div>
