	...
	<div style="float: right; width: 85%;">
		<div class="container top">
			...
			<ul class="pagination">
				...
				<li><a href="getCAList_leader.action?vo.cur=1">首页</a></li>
				<c:if test="${vo.cur==1}">
					<li class="disabled"><a>上一页</a></li>
				</c:if>
				<c:if test="${vo.cur!=1}">
					<li><a href="getCAList_leader.action?vo.cur=${vo.cur-1}">上一页</a></li>
				</c:if>
				<c:if test="${vo.cur==vo.total}">
					<li class="disabled"><a>下一页</a></li>
				</c:if>
				<c:if test="${vo.cur!=vo.total}">
					<li><a href="getCAList_leader.action?vo.cur=${vo.cur+1}">下一页</a></li>
				</c:if>
				<li><a href="getCAList_leader.action?vo.cur=${vo.total}">尾页</a></li>
				<li><a>
						<form class="form-inline" name="fenyeStaff"
							action="getCAList_leader.action" method="post">
...
<script>
	function change_select() {
		...
		a.action = "searchCAList_leader.action?cur=1";
	}
