	...
	<div style="width:100%">
		...
		<div style="float:right;width:85%;">
			<div class="container top">
				<div><h4 class="text-center"><strong>查看会议</strong></h4></div>
				<!-- 会议修改 -->
				<form class="form-horizontal" role="form" action="updateMeeting.action?vo.mid=${vo.mid}" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" value="${vo.mname}" readonly></div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">会议开始时间</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" value="${vo.starttime}" readonly>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" value="${vo.endtime}" readonly>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">会议地点</label>
							...
							<div class="col-sm-10">
							<input class="form-control" type="text" value="${vo.mroom.mname}" readonly>
						</div> 
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<textarea class="form-control" rows="3" name="vo.meetingPerson" id="handinput" placeholder="可手动输入，人名以;隔开" readonly><c:forEach items="${meetingUsers}" var="mu">${mu.name};</c:forEach></textarea>
						</div>
					</div>
					<div class="form-group">
						<!-- <div class="col-sm-offset-2 col-sm-2">
