	...
	<div style="width:100%">
		...
		<div style="float:right;width:85%;">
			<div class="container top">
				<div><h4 class="text-center"><strong>新增会议</strong></h4></div>
				<form class="form-horizontal addmeeting" role="form" action="addMeeting.action" method="post">
					<!-- <div class="form-group">
						<label class="col-sm-2 control-label">会议编号</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" value="101" readonly></div>
					</div> -->
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class='col-sm-10'>
							<div class='input-group' id='meeting_start'>
								<input type='text' class="form-control" name="vo.starttime" placeholder="开始时间" readonly />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class='input-group' id='meeting_end'>
								<input type='text' class="form-control" name="vo.endtime" placeholder="结束时间" readonly />
								<span class="input-group-addon">
									<span class="glyphicon glyphicon-calendar"></span>
								</span>
							</div>
							 ...
							 <select onchange="checkdept()" name="vo.mrid" class="form-control">
									      <option value="">--请选择--</option>
				                             <c:forEach items="${mr}" var="mroom">
					                              <option value="${mroom.mrid}">${mroom.mname}</option>
				                             </c:forEach>
	                                  </select>
                        </div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<textarea class="form-control" rows="3" name="vo.meetingPerson" id="handinput" placeholder="可手动输入，人名以;隔开"></textarea>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-2">
