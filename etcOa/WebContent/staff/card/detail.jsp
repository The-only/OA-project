		...
		<div class="top">
			...
			<div class="container">
				...
				<form class="form-inline well" role="form"
					action="getCardsByName_staff.action?vo.cid=${vo.cardfloder.cid }&vo.cur=1"
					method="post">
				...
				<table class="table table-striped">
					...
					<c:forEach items="${vo.cards}" var="card">
						<tr>
							<td>${card.cname }</td>
							<td><a href="getCard_staff.action?vo.cid=${card.cardid }">详细信息</a></td>
							<td><a href="deleteCard_staff.action?vo.cid=${card.cardid}"
				...
				<ul class="pagination">
					...
					<li class="disabled"><a
						href="getCards_staff.action?vo.cid=${vo.cardfloder.cid }&vo.cur=1">首页</a></li>
					<c:if test="${vo.cur==1}">
						<li class="disabled"><a>上一页</a></li>
					</c:if>
					<c:if test="${vo.cur!=1}">
						<li><a
							href="getCards_staff.action?vo.cid=${vo.cardfloder.cid }&vo.cur=${vo.cur-1}">上一页</a></li>
					</c:if>
					...
					<c:if test="${vo.cur!=vo.total}">
						<li><a
							href="getCards_staff.action?vo.cid=${vo.cardfloder.cid }&vo.cur=${vo.cur+1}">下一页</a></li>
					</c:if>
					<li><a
						href="getCards_staff.action?vo.cid=${vo.cardfloder.cid }&vo.cur=${vo.total}">尾页</a></li>
					<li><a>
							<form class="form-inline" name="cardStaff"
								action="getCards_staff.action.action?vo.cid=${vo.cardfloder.cid }" method="post">
