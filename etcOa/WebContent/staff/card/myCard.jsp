	...
	<div style="float: right; width: 85%;">
		<div class="top">
			<div class="info_main" style="width: 960px;">
				...
				<form class="form-inline well" role="form" action="sendCard_staff.action"
					method="post">
				...
				<form role="form" action="getIndex_staff.action" method="post">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="updateCard_staff.action" method="post">
