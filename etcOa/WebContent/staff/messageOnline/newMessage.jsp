				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input name="vo.title" type="text" class="form-control"
							id="message-title" placeholder="">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">活动内容</label>
					<div class="col-sm-10">
						<textarea name="vo.content" class="form-control" rows="3"></textarea>
					</div>
				</div>
...
<script>
	function change_select() {
		...
		a.action = "newMessage_staff.action?vo.issend=1";
	}
	function change_output() {
		var a = window.document.getElementById("select_output");
		a.action = "newMessage_staff.action?vo.issend=0";
	}
</script>
<!-- footer -->
