	...
	<div style="float: right; width: 85%;">
		<div class="container top">
			...
			<table class="table table-striped table-bordered">
				...
				<c:forEach items="${us}" var="u">
					<tr>
						...
						<td><a
							href="/etcOa/deleteUS.action?vo.usid=${u.schedule.hid}">删除</a></td>
						<td><a>未完成</a></td>
						<td></td>
					</tr>
				</c:forEach>
			...
			<ul class="pagination">
				...
				<li><a href="/etcOa/undolistwork.action?vo.cur=1">首页</a></li>
				<c:if test="${vo.cur<=1}">
					<li><a>上一页</a></li>
				</c:if>
				<c:if test="${vo.cur>1}">
					<li><a href="/etcOa/undolistwork.action?vo.cur=${vo.cur-1 }">上一页</a></li>
				</c:if>
				<c:if test="${vo.cur<vo.total}">
					<li><a href="/etcOa/undolistwork.action?vo.cur=${vo.cur+1 }">下一页</a></li>
				</c:if>
				<c:if test="${vo.cur>=vo.total}">
					<li><a>下一页</a></li>
				</c:if>
				<li><a href="/etcOa/undolistwork.action?vo.cur=${vo.total}">尾页</a></li>
				<li><a>
						<form class="form-inline" name="selectEmp"
							action="/etcOa/undolistwork.action" method="post">
